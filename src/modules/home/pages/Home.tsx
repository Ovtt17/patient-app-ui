    ...
    <HeaderHome>
      ...
      <section className="relative w-full h-[350px] md:h-screen">
        ...
        <div className="absolute inset-0 bg-blue-900/40 backdrop-blur-sm flex flex-col items-center justify-center text-center text-white font-serif px-6">
          ...
          <button className="mt-8 px-10 py-4 bg-white text-blue-900 rounded-3xl font-semibold shadow-lg hover:shadow-xl hover:bg-gray-200 transition-all duration-300 text-lg md:text-xl">
            Agenda tu cita
          </button>
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-24 px-6 md:px-12">
        <div className="max-w-6xl mx-auto font-serif text-gray-800 leading-relaxed text-xl md:text-2xl">
          <h3 className="text-4xl md:text-5xl font-bold text-blue-900 mb-10 text-center">
            Nuestra Historia
          </h3>
          <p className="mb-6">
      ...
      {/* Footer */}
      <footer className="bg-blue-900 text-white text-center py-8 px-6 text-lg md:text-xl font-serif">
