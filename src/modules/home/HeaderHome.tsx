      ...
      <header className="bg-white shadow-md">
        <div className="container mx-auto flex items-center justify-between py-4 px-6">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-lg sm:text-2xl font-['Times_New_Roman'] text-blue-400">
                Hospital
              </h1>
              <h1 className="text-lg sm:text-2xl font-bold font-['Times_New_Roman'] text-blue-800">
                Salud y Vida
              </h1>
            </div>
          </div>
          ...
          {/* Menú desktop */}
          <nav className="hidden sm:flex flex-1 justify-center gap-x-18 font-serif text-xl text-blue-900 font-medium">
            ...
            <Link to="/registrate" className="hover:text-blue-600 text-xl">Registrate</Link>
            <Link to="/inicia-sesion" className="hover:text-blue-600 text-xl">Inicia Sesion</Link>
          </nav>
        ...
        {/* Menú móvil */}
        {menuOpen && (
          <nav className="sm:hidden flex flex-col space-y-3 bg-blue-50 px-6 py-4 text-blue-900 font-medium text-lg">
            ...
            <Link to="/inicia-sesion" className="hover:text-blue-600">Inicia Sesion</Link>
          </nav>
        )}
      </header>
